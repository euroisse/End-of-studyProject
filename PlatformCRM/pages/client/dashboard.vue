      ...
      <div class="grid grid-cols-2 gap-8">
        ...
        <div class="bg-white rounded-lg shadow-sm p-6">
          <div class="flex justify-between items-center mb-6">
            <h2 class="text-xl font-bold">Messages récents</h2>
            <Button
            content=" Voir tout"
              CustomClass="text-indigo-600 hover:text-indigo-700 font-medium cursor-pointer whitespace-nowrap"
            />
          </div>
          ...
          <div class="space-y-4">
            ...
            <div class="flex items-start p-4 bg-gray-50 rounded-lg">
              ...
              <div class="flex-1">
                ...
                <p class="text-gray-600 text-sm">
                  Point d'étape sur le développement prévu demain à 14h.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="space-y-4">
            ...
            >
              <div class="flex items-center">
                <i class="fas fa-file-invoice-dollar text-indigo-600 mr-4"></i>
                <div>
                  <h4 class="font-medium">Facture #2025-04</h4>
                  <p class="text-sm text-gray-500">Échéance: 25/04/2025</p>
                </div>
              </div>
              <div class="flex items-center">
                <span
            ...
            >
              <div class="flex items-center">
                <i class="fas fa-file-invoice-dollar text-indigo-600 mr-4"></i>
                <div>
                  <h4 class="font-medium">Facture #2025-03</h4>
                  <p class="text-sm text-gray-500">Échéance: 11/04/2025</p>
                </div>
              </div>
              <div class="flex items-center">
                <span
