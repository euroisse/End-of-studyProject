      ...
      <div class="md:w-1/2 p-6 md:p-8">
        <div class="flex mb-8 border-b border-gray-200">
          <button
            ...
            :class="['px-4 py-3 font-medium whitespace-nowrap cursor-pointer',
              activeTabLocal === 'login' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-blue-500']"
          >
            Connexion
          </button>
          <button
            ...
            :class="['px-4 py-3 font-medium whitespace-nowrap cursor-pointer',
              activeTabLocal === 'register' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-blue-500']"
          >
            Créer un compte
          </button>
        </div>
        ...
        <SingUp v-if="activeTabLocal === 'register'" @register="handleRegister" />
      </div>
    </div>
  </div>
</template>
