...
INSERT INTO "new_Invoice" ("amountPaid", "balanceDue", "createdAt", "id", "invoiceDate", "invoiceNumber", "paymentMethod", "quoteId", "totalAmount", "userId") SELECT "amountPaid", "balanceDue", "createdAt", "id", "invoiceDate", "invoiceNumber", "paymentMethod", "quoteId", "totalAmount", "userId" FROM "Invoice";
DROP TABLE "Invoice";
